...
//import com.fish.ab.base.util.baseutil.widget.VirturlUtil;
import com.fish.ab.base.view.LoadingDialog;
import com.jaeger.library.StatusBarUtil;


public abstract class BaseNoModelActivity<ViewDB extends ViewDataBinding> extends AppCompatActivity {

    protected ViewDB dataBinding;
...
//        VirturlUtil.assistActivity(findViewById(android.R.id.content));
     ...
     * 初始化DataBinding
     */
    protected ViewDB initDataBinding(@LayoutRes int layoutId) {
